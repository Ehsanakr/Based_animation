...
(function (cjs, an) {
  ...
  (lib.Tween24 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AJcCVIiBgzQhOgfh2gdQh3geiJgFQiJgEg8AHQg8AHgYAEQgZADhXAVQhXAUheAkQheAkAKgaQAJgaAwgpQAvgpAxgeQAygeBVgfQBUggA/gNQA/gMCKgEQCLgFBuAjQBvAiBDApQBDAoAzAkQAyAlAeA1QAVAlgUAAQgIAAgPgGg"
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AkMAdQBRAJBXgEIAwgDQAjgDAhgEQA7gIA4gNQBHgPBDgZIAAAFQjUBGi+AAQhFAAhCgJg"
      );
  ...
  (lib.Tween22 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AiZCdQAMgpBgh/QBihsAlgWQAkgXAQgIQAQgJACAHQACAHgFBFQgFBFgjAKQgkAKhSAlIAAAAQgcAPg2A1QgxAvgcAjIAHgVg"
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AhJI8IAaAAIgggiIABgTIACgkIAziaQCbnRBchjQBph0BTANIBAADQh9BphKBqQhNBth8FnIgsCTIgZBWgAnYDVQgPipCHlNQCIlPA9A5QA8A4hiDRQhkDSh3Fmg"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AgBBwQg2gIg8gEQg9gFg4gCQg5gChVAOQhVAOAIgQQAIgQALgHQAMgIAggNQAhgOCPgMQCagOBPgTQAmgKCWguQCVgvAvgFQAugGACAFQABAEgeAPQgfAPgVANIiqBhQiKBOg4AAIgJgBg"
      );
  ...
  (lib.Tween21 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AgcHcQgShTgGiuQgHi8AejVQAdjVA2hQ");
  ...
  (lib.Tween3 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape_2.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("ACrg3IAABiQg1ANhqgBQhWAChggLIAAhj");
    ...
    this.shape_3.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AiOg+IFOgCQADAAAEgBQCYgJCCgZQgfCYj7AkQitASiegMQkwgggsiaQDIAXCKAGg");
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "Ah+BfQkjgggqiaQDAAXCDAGIAABjQBcAMBSgCQBlABAzgNIAAhiIg9AAIA2gBIAHgBQCSgJB8gZQgdCYjxAkQhjALhdAAQg/AAg9gFg"
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AiiAuIAAhjIAAgBICtAAIBbgBIA9AAIAABiQgzANhlgBIAAhtIAABtIgXABQhJAAhNgKg"
      );
  ...
  (lib.Tween2 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("ACpguQgiA1g6AUQg7AUhLAAQgiAAgfgLQgOgEgMgGQgLgGgJgI");
    ...
    this.shape_2.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("ACxgMIgIABIgLADIgxAIQhMAThwgIIgkgEIg9gN");
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        ""
      );
  ...
  (lib.Tween1 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "Ag7LwIDTqjQAGgUAFgTQAQgwALgxQA3jaALjdQAOiVgThVQgRgkgmAjQiBBPhYC+QhgCwg1C5QgPA0gMAzQgMAwgJAxQgdCSgJCTQgDAkgBAjQgECJAdCA"
      );
    ...
    this.shape_2.graphics
      .f("#2B635D")
      .s()
      .p("AhrGHQgpilBUleQBSlgBEAvQBFAuhCDeQhCDeg0F2g");
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AiECyQAGgqBLiNQBRh5AhgcQAggcAPgKQAOgLADAGQADAGAGBFQAFBFghAQQgiAPhLAyIAAgBQgaATgtA9QgpA1gXAoIAEgWg"
      );
    ...
    this.shape_6.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AiQKbIETorQAJgSAJgTQAWguAUguQBWjOAtjaQAkiRgGhWQgKgngrAdQiMA7h1CuQh4CfhRCvQgWAxgUAxQgTAugRAuQgzCNgfCQQgIAjgHAjQgZCGAJCD"
      );
    ...
    this.shape_7.graphics
      .f("#2B635D")
      .s()
      .p("AgwhrQCHlPA9A4QA8A4hjDSQhjDQhOEdIhkAWQgPipCHlNg");
    ...
    this.shape_8.graphics
      ...
      .s()
      .p(
        ""
      );
  ...
  (lib.Symbol2 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s("#00FF00")
      .ss(3, 0, 1)
      .p("ADQARIjXjIIjDAoIFeDmIAEALAjKiPIBRC7IEWCO");
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "Ah7ArIhSi7IFeDmIAFALIAdA1IgYAjgACCA2IAPAgIlejmIDEgoIDXDIQgHBWgYAAQgSAAgbgwg"
      );
    ...
    lib.Symbol2,
    new cjs.Rectangle(-22.1, -20, 44.2, 40.1),
    null
  );
  (lib.Symbol1 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AA/A4IgMgGIgLgEIgKgEQgEgCgFgGQgLgMgMgIIgOgIIgKgEIgLgCQgJAAgMgHIgMgGQgMgGgEgHQgHgLAHgLQAHgLAMACQAGABAJAGIAPAIIAVAFQAIACANAHQAYANAMAKIANALIAXANQANAIAAAMQABAKgKAGQgEADgFAAQgFAAgEgCg"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AgGAUQgMAAgFgCQgLgFAAgNQAAgLAMgFQADgBAQgBIAUgBQAMABAEAKQACAFgBAEQgBALgIAFQgFADgKAAg"
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AgIAVQgIgBgFgDQgFgDgDgGQgDgGAAgFQABgMALgEQADgBAGABIAJABIANABQAIABAFADQAJAHgBAKQgBALgKAEQgFACgLAAIgNAAg"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AgWAfQgLgBgGgFQgGgFgBgJQgBgLAIgIQAGgGAJAAIALACQAGABAHgEIALgIQAPgLALAFQAGADADAIQACAHgDAHQgEALgRAJQgYAPgUAAIgCAAg"
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "AAFA7QgVgCgmgSQgRgIgFgGIgKgMQgJgNgDgJQgDgIAAgOQABgUALgGQAJgEAIAFQAIAFABAKQgBAOADAGIAIAIIAIAJQAEAEAOAGQAUAJAGACQAQAFAUgDIALgBQAHgCAIgEIARgHQAHgBAGACQAGACADAFQAEAGgCAIQgCAIgFAFQgIAIgSAFQgMAEgKACIgUABIgWgBg"
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AAiAlQgEAAgGgDQgHgEgEAAQgFgBgIABIgNABQgNgBgQgQQgQgOgBgNQAAgGAEgGQAEgGAGgDQAIgDAKABIAYAFQAYAHAKAEQAPAHAHAIQAFAFABAIQACAIgDAGQgCAHgHAFQgGADgGAAIgDAAg"
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "ACIBkQg/gJgmgPQgTgIgfgSIhQgtIgagOQgUgLgKgIQgPgMgFgOQgIgVALgQQAGgHALgCQAKgBAHAGQAEADADAHIAGAMQAGAJAQAJQAxAdBBAjQAgASAXAHQARAFAWAEIAbAFQAeAFAHANQAEAJgDAKQgEAKgJAEQgEACgIAAIgNgBg"
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "AlcLQQDDosAEgQQAFgRAGgOQAnhPAMggQA3iNA4jvQAshfBLjIQBFi4AAgKQjsCpA+hYQA/hZBthgQBthgAwAAQAgAAAaAeQArAygNDuQgNDtgQgRQgRgSgMhRQgNhSgMgEIgUgIIgYAeIjnJtQiiFSgbAoQgcAog7B3Qg7B3iZFYQg6CDgHAAQgNAAB5lYg"
      );
    ...
    lib.Symbol1,
    new cjs.Rectangle(-45.8, -180.2, 175.2, 286.6),
    null
  );
  (lib.eye1 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AicA8IAMgCIgEABIgGABIgCAAgAicA8QgMgBgBgJQAAgNAFgMQAfgsAWgLQAkgSAbgEQBRgTBIAnQBIAmgIAMQgJAMgEgDQgEgDgMAHIgCABIhFAHIgcgBQgwgBhLAOQgTAEgKAAIghADIgMACIAAAAgAiQA6IAAAAgABKAoIgFgBIBFgHQgNAHgTABIgLAAIgVAAgACKAgIAAAAg"
      );
    ...
    this.shape_2.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "ABKACQAAAjgWAYQgVAZgfAAQgeAAgXgZQgVgYAAgjQAAgiAVgZQAXgYAeAAQAfAAAVAYQAWAZAAAigADpAAQAABthEBNQhEBNhhAAQhgAAhEhNQhEhNAAhtQAAhsBEhNQBEhNBgAAQBhAABEBNQBEBNAABsg"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "Ag0A7QgVgYAAgjQAAgiAVgZQAWgYAeAAQAfAAAVAYQAXAZgBAiQABAjgXAYQgVAZgfAAQgeAAgWgZg"
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "Ai4A7QgCgGAIggQAHgfAygqQAygqBEACIABAAQA1gDA0AnQA0AmASAqQASAqgJAOQgJAOgNgZQgNgagwgnQgxgngzADQgmACgsAiQgnAfgEAMQggAugOAAQgMAAAAgig"
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        ""
      );
  ...
  (lib.brow2 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AikAlQAbg6BUgZQAvgOAxAFQBVALAhA2QAFAHADALQAEATgWgGIgagNQgqgUhCgBQhKgBhAAnQgTAMgXABQgKgCAJgTg"
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "ACxB9IgFAAQgJgBgUgHQgUgGgKgBQgLgBgPABIgZADQgXACgpgCQgtgCgUABIgoAEQgYACgQAAQgwgBgbgWQgagUAVgjQAUgjAIgZQAHgaAyghQAygiBLgJQBcgLBEApQBGBuANAoQAPAsgFAEQgEAFgFADQgSAKgSABg"
      );
  ...
  (lib.Tween26 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "ACCmbIAghiABKkrIAXhdAA6AYQgZAYALAaAiMEzQgUgSgBhZQgBhVAQiSAARhaIAWhcAhGH+IAVha"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        ""
      );
  ...
  (lib.Symbol3 = function (mode, startPosition, loop, reversed) {
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "AgCEBQhzgsgzgPQgFg6gThHQgThGgGgcIBCggIACgVQAFg6ATglQAVgsAngQQAMgEAMgCIAuAhQBYA/AUAXIAFAFIAFAGIAOAQIABAAQAkAjApAdIgCAKIAFAEIgGgCQgDAOgNggIgRAzIAAAxIACACIAeATIAAACIAAAGIABAAIAAAKIABAIQgDACAAACIAAABIAAAxQAAAggGAOQgEANioAyIgigOgAhMkOIAEADIgCADg"
      );
    ...
    this.shape_6.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
    this.shape_6.setTransform(19.35, 143.92);
    this.timeline.addTween(
      cjs.Tween.get(this.shape_6).wait(129).to({ _off: true }, 1).wait(90)
    );
    // Layer_13
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        ...
        .to({ _off: false }, 0)
        .to(
          { scaleX: 0.9476, scaleY: 1.451, x: 16.65, y: -41.2 },
          5,
          cjs.Ease.get(1)
        )
        .to({ regX: 0.1, regY: -0.1, scaleX: 0.9805, x: 16.4, y: -38.55 }, 5)
        .to({ startPosition: 0 }, 42)
        .to({ scaleY: 1.1865, y: -39.05 }, 1)
        .to({ _off: true }, 1)
        .wait(122)
    );
    // brow
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_1)
        ...
        .to(
          { regX: 0, regY: 0, scaleX: 0.9277, scaleY: 1, x: 19.8, y: -110.25 },
          5,
          cjs.Ease.get(1)
        )
        .to(
        ...
        .wait(1)
        .to({ regX: -0.8, regY: 0.6, x: 18.85, y: -103.8 }, 0)
        .wait(1)
        ...
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ regX: 0.1, regY: -0.2, x: 19.7, y: -104.55 }, 0)
        .to(
          { regY: -0.3, scaleY: 0.6726, x: 16.45, y: -107.85 },
          1,
          cjs.Ease.get(1)
        )
        .to({ _off: true }, 1)
    ...
    this.shape_7.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLARQBsgpEnAAQBnAABaAJQCBANBCAb");
    ...
    this.shape_8.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLARQBrgoEmgBQBmAABbAJQCDAMBCAc");
    ...
    this.shape_9.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLARQBqgoEgAAQBlgBBbAJQCJAMBEAb");
    ...
    this.shape_10.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLASQBngnEWgCQBkgBBcAIQCTALBHAd");
    ...
    this.shape_11.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLASQBjgmEIgCQBjgCBdAHQCiALBKAd");
    ...
    this.shape_12.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLAUQBfglD0gDQBigEBeAGQC1AJBPAg");
    ...
    this.shape_13.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLAVQBZgjDegFQBggEBgAFQDMAHBUAh");
    ...
    this.shape_14.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLAWQBSggDEgIQBfgFBhADQDmAFBbAj");
    ...
    this.shape_15.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmLAXQBLgeCkgKQBdgHBjACQEFADBjAl");
    ...
    this.shape_16.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AGMARQhsgpknAAQhnAAhaAJQiBANhCAb");
    ...
    this.shape_17.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmSALQBLgLCEgFQBrgCCDgCQEAgCBoAO");
    ...
    this.shape_18.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmYACQBTACCGABQB5ABCZgDQDggDBmgF");
    ...
    this.shape_19.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmcgFQBZALCHAFQCCAFCpgEQDKgFBkgT");
    ...
    this.shape_20.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmfgKQBcARCJAHQCHAHC0gFQC8gFBjgc");
    ...
    this.shape_21.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AGhgTQhjAfi4AGQi2AFiJgIQiJgIhegS");
    ...
    this.shape_22.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmggLQBeASCJAIQCJAIC2gFQC4gGBjgf");
    ...
    this.shape_23.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmggFQBeASCOAAQCOAACzABQCzAABhgb");
    ...
    this.shape_24.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmggCQBeASCTgIQCUgHCuAGQCwAHBegX");
    ...
    this.shape_25.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmgAAQBeASCZgQQCZgPCqANQCsALBbgT");
    ...
    this.shape_26.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmgAFQBeATCegYQCegWCnASQCnARBZgP");
    ...
    this.shape_27.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AGhAEQhWAMikgXQijgZijAgQijAfhegT");
    ...
    this.shape_28.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmegIQBfAMCZAHQCGAHCtgEQCygDBggZ");
    ...
    this.shape_29.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmcgGQBhAGCoAGQCDAHCkgCQCtgCBcgT");
    ...
    this.shape_30.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmagEQBiABC5AFQB+AFCcAAQCmAABagN");
    ...
    this.shape_31.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmXAAQBjgFDJAEQB6AECSABQCiACBVgH");
    ...
    this.shape_32.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmVADQBkgKDZAEQB3ADCJACQCcAEBSgC");
    ...
    this.shape_33.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmTAHQBmgRDoAEQB0ADB/ADQCXAEBPAE");
    ...
    this.shape_34.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmRAJQBngWD5ACQBwADB2AEQCSAGBLAK");
    ...
    this.shape_35.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmPALQBogcEJACQBsABBuAGQCMAIBIAQ");
    ...
    this.shape_36.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("AmNAOQBqgiEZABQBpABBkAHQCGALBFAV");
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_2)
        ...
        .to({ startPosition: 0 }, 44)
        .to(
          { regY: -0.9, scaleX: 1.0043, scaleY: 1.0009, x: 15.2, y: -77.7 },
          10,
          cjs.Ease.get(1)
        )
        .wait(1)
        .to({ regX: 0, regY: 0, x: 14.4, y: -76.8 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        ...
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ regX: 0.8, regY: -0.9, x: 15.2, y: -77.7 }, 0)
        .to({ _off: true }, 1)
        .wait(90)
    );
    // stubble
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_3)
        ...
        .to({ scaleX: 1.0261 }, 15)
        .to({ scaleX: 1.0067, x: 19.5, y: -21.85 }, 5)
        .to({ scaleX: 1.0261, x: 19.7, y: -18.6 }, 5)
        .to({ startPosition: 0 }, 44)
        .to(
          { regX: 0, regY: 0, scaleX: 1, scaleY: 1, x: 14.4, y: -27.15 },
          10,
          cjs.Ease.get(1)
        )
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_4)
        .to({ startPosition: 0 }, 15, cjs.Ease.get(-1))
        .to(
          { regY: -0.1, skewY: 180, x: 16.95, y: -102.8 },
          9,
          cjs.Ease.get(-1)
        )
        .to(
          { scaleX: 1.0534, scaleY: 1.0608, x: 17.2, y: -88.5 },
          5,
          cjs.Ease.get(1)
        )
        .to({ startPosition: 0 }, 15)
        ...
        .to({ startPosition: 0 }, 44)
        .to(
          { regY: 0, scaleX: 1, scaleY: 1, skewY: 0, x: 11.15, y: -102.75 },
          10,
          cjs.Ease.get(1)
        )
        .wait(1)
        .to({ regX: -0.2, x: 10.95 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_5)
        ...
        .to({ regX: 0.3, regY: 0.7, y: -42.55, startPosition: 1 }, 1)
        .to(
          {
            regX: 0.5,
            regY: 0.5,
        ...
        .to({ regX: 0.8, regY: 0.2, scaleX: 0.9909, x: 78.95, y: -52.05 }, 5)
        .to({ scaleX: 0.9922, scaleY: 0.9415, x: 79.15, y: -52.6 }, 43)
        .to(
          {
            scaleX: 0.9935,
            scaleY: 0.9512,
        ...
        .to({ x: 71.25 }, 10, cjs.Ease.get(1))
        .wait(1)
        .to({ regX: -59.7, regY: -1.6, x: 11.15, y: -61.35 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        ...
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ regX: 0.8, regY: 0.2, x: 71.25, y: -59.65 }, 0)
        .to({ _off: true }, 1)
        .wait(90)
    );
    // Layer_9
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_6)
        ...
        .to({ startPosition: 0 }, 15)
        .to({ regX: 0.3, regY: -0.2, scaleX: 0.9587, x: 19.75, y: -78.95 }, 5)
        .to(
          {
            regX: 0.1,
            regY: -0.1,
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_7)
        ...
        .to({ startPosition: 0 }, 15)
        .to(
          { regX: 0.3, scaleX: 0.9802, scaleY: 0.989, x: 14.15, y: -75.95 },
          5
        )
        .to({ regX: 0.2, scaleX: 1.0142, scaleY: 0.9626, x: 14, y: -72.95 }, 5)
        .to({ startPosition: 0 }, 44)
        .to(
          { regX: 0, regY: 0, scaleX: 1, scaleY: 1, x: 14.6, y: -76.75 },
          10,
          cjs.Ease.get(1)
        )
        .wait(1)
        .to({ regY: -0.1, y: -76.85 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_8)
        ...
        .to({ _off: false }, 0)
        .to(
          { regX: -55.6, rotation: 0, x: 12.5, y: -131.95 },
          9,
          cjs.Ease.quadInOut
        )
        ...
        .wait(1)
        .to({ regX: 0, regY: 14, x: 71.05, y: -185.15 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        ...
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ regX: -55.6, regY: 71.1, x: 12.5, y: -131.95 }, 0)
        .to({ _off: true }, 1)
        .wait(121)
    );
    // ears
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_9)
        .to({ startPosition: 0 }, 15, cjs.Ease.quadInOut)
        .to({ rotation: -13.1957, x: 2.35 }, 9, cjs.Ease.quadInOut)
        .to({ _off: true }, 1)
        .wait(74)
        .to(
          {
        ...
        .wait(1)
        .to({ regX: -17.4, regY: -1.3, x: 19.55, y: -217.5 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ startPosition: 0 }, 0)
        ...
        .to({ startPosition: 0 }, 0)
        .wait(1)
        .to({ regX: -2.8, regY: 70.4, x: 33.9, y: -145.75 }, 0)
        .to({ _off: true }, 1)
        .wait(90)
    );
    // Layer_17
    ...
    this.shape_37.graphics
      ...
      .s()
      .p(
        "AiYIxQgKgFgDgJQgEgKAEgJQACgGAQgZIAJgQIAFgOQADgKAKgFQAJgFAKADQAJADAFAKQAFAJgDAKQgGATgNAWIAAABIgPAYQgFAJgJAEIgFABIgEABQgFAAgFgCgAAlnOQAEAAArgjQArgjAFgGQAGgJAPgLQAOgKABARQABAQgVAWQgVAWgUANQgUANgbAIQgKADgGAAQgKAAADgIg"
      );
    ...
    this.shape_38.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
    ...
    this.shape_40.graphics
      ...
      .s()
      .p(
        "Ai7IaQAOALgNAQQgBgNAAgOgAAsoNQAbgpA4ADQAJALAdAKQAeAJgKAMQgJAMggAAQggAAhGAIIgPACIARgag"
      );
    ...
    this.shape_42.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
    ...
    this.shape_43.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_44.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({
          state: [
            { t: this.shape_41, p: { x: -42.2025 } },
            { t: this.shape_40, p: { x: -41.9426 } },
            { t: this.shape_39, p: { x: -44.8 } },
            { t: this.shape_38, p: { x: -40.1587 } },
            { t: this.shape_37, p: { x: -42.1168 } },
          ],
        })
        .to(
          {
            state: [
              { t: this.shape_43, p: { x: -42.2025 } },
              { t: this.shape_40, p: { x: -41.9426 } },
              { t: this.shape_39, p: { x: -44.8 } },
              { t: this.shape_42 },
              { t: this.shape_37, p: { x: -42.1168 } },
        ...
        .to(
          {
            state: [
              { t: this.shape_41, p: { x: -42.7025 } },
              { t: this.shape_40, p: { x: -42.4426 } },
              { t: this.shape_39, p: { x: -45.3 } },
              { t: this.shape_38, p: { x: -40.6587 } },
              { t: this.shape_37, p: { x: -42.6168 } },
            ],
          },
          39
        )
    ...
    this.shape_46.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_47.graphics
      ...
      .s()
      .p(
        "AhMAiQgTgEAHgKQAGgKAigTQAhgUAWgDQAXgCAZABQAZACAIALQAJAMgSAGQgSAFgLABIgtAGQgXADgUAMQgRAJgOAAIgHAAg"
      );
    ...
    this.shape_48.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_49.graphics
      ...
      .s("#37FF08")
      .ss(5, 1, 1)
      .p("AABAAQgBAAAAAAQAAAAABAAQAAAAAAAAQAAAAAAAAIAAAA");
    ...
    this.shape_50.graphics
      ...
      .s("#37FF08")
      .ss(5, 1, 1)
      .p("AABAAIAAAAQAAAAAAAAQAAAAAAAAQgBAAAAAAQAAAAABAA");
    this.shape_50.setTransform(4.2375, 16.7375);
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.shape_49 }] })
        .to({ state: [{ t: this.shape_50 }] }, 15)
        .to({ state: [{ t: this.shape_49 }] }, 39)
        .to({ state: [{ t: this.shape_49 }] }, 75)
        .to({ state: [] }, 1)
        .wait(90)
    );
    // Layer_1
    ...
    this.shape_52.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_58.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_59.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_60.graphics
      ...
      .s()
      .p(
        "AiqE8QgVgFgPgUQgNgSgFgZQgMg7AahGQARguAuhKICTjzQARgbAMgNQASgVAVgHQAXgJAaAIQAZAHAUATQAeAcAUA8QAUA4gDAqQgCAWgJAcQgGAQgNAgIhdDTQgLAbgKAPQgNAVgSAKQgWAMgpgBQgzgBgRADIguARQgUAHgPAAIgMgCg"
      );
    ...
    this.shape_61.graphics
      ...
      .s()
      .p(
        "AhVCfQgLgCgHgKQgHgKgCgMQgGgeANgjQAIgXAXglIBKh6QAJgOAGgHQAJgKAKgEQAMgEANAEQANADAKAKQAPAOAKAeQAKAcgCAVQAAAMgFAOIgKAYIguBqQgGAOgFAHQgHALgJAFQgLAGgUgBQgaAAgIABIgYAJQgJADgIAAIgGgBg"
      );
    this.shape_61.setTransform(-616.3095, 1047.2225);
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.instance_10 }] }, 44)
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_11)
        .to({ startPosition: 0 }, 15, cjs.Ease.quadInOut)
        .to({ rotation: 7.4946 }, 14, cjs.Ease.quadInOut)
        .to({ rotation: 7.4946 }, 15)
        .to(
          { regX: 58.3, regY: -79.8, rotation: 14.9354, x: -27.05, y: 23.6 },
          3,
          cjs.Ease.get(1)
        )
        .to(
          { regX: 58.4, regY: -79.9, rotation: 7.4946, x: -33.3, y: 28.7 },
          11
        )
        .to({ startPosition: 0 }, 40)
        .to({ rotation: -6.7404 }, 8, cjs.Ease.get(1))
        .to({ rotation: -6.7404 }, 23)
        .to({ _off: true }, 1)
        .wait(90)
    );
    // Layer_14
    ...
    this.shape_62.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AnyGSQgUhYgZifQgYifAChBQACgoAKhPQATiSAehYQAPgqARgcQAPgXAigkQBwhyCQhHQAXgLANAEQAMAEAGANQAGANgDANQgCAMgHANQgEAHgKAPQgRAcgWA9Qg8ClgdBZQgSA3gIAkQgLAyABArQAAAnAKAzQAGAdHCDwQHDDxg9CSQg+CRl2gXQl1gYgNANQgIAIgQAFQgEABgTgEQgTgEhDgZQhAgZgJhjQgJhjgUhXg"
      );
    ...
    this.shape_63.graphics
      ...
      .s()
      .p(
        "AB7LmQl1gYgNANQgIAIgQAFQgEABgTgEQgTgEhDgZQhAgZgJhjQgJhjgUhXQgUhYgZifQgYifAChBQACgoAKhPQATiSAehYQAPgqARgcQAPgXAigkQBwhyCQhHQAXgLANAEQAMAEAGANQAGANgDANQgCAMgHANIgOAWQgRAcgWA9Qg8ClgdBZQgSA3gIAkQgLAyABArQAAAnAKAzQAGAdHCDwQHDDxg9CSQg1B9kdAAQguAAg0gDg"
      );
    this.shape_63.setTransform(-5.068, 110.7144);
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [{ t: this.shape_63 }, { t: this.shape_62 }] })
        .to({ state: [{ t: this.shape_63 }, { t: this.shape_62 }] }, 15)
        .to({ state: [{ t: this.shape_63 }, { t: this.shape_62 }] }, 43)
        .to({ state: [{ t: this.shape_63 }, { t: this.shape_62 }] }, 71)
        .to({ state: [] }, 1)
        .wait(90)
    );
    this._renderFirstFrame();
  ...
  an.makeResponsive = function (isResp, isScale, scaleType, domContainers) {
    var lastS = 1;
...
var canvas2, stage2, exportRoot2, fnStartAnimation2;
function init2() {
  canvas2 = document.getElementById("canvas");
  dom_overlay_container = document.getElementById("dom_overlay_container");
  var comp = AdobeAn.getComposition("367C7A929D59DB45BEA40A799CC821FC");
...
function handleComplete2(evt, comp) {
  ...
  AdobeAn.makeResponsive(false, false, 1, [canvas2]);
