(function (cjs, an) {
  ...
  an.makeResponsive = function (domContainers) {
    ...
    function resizeCanvas() {
        ...
        var containerWidth = domContainers[0].offsetWidth;
        var containerHeight = domContainers[0].offsetHeight;

        var pRatio = window.devicePixelRatio || 1,
            xRatio = containerWidth / w,
            yRatio = containerHeight / h,
            sRatio = 1;
...
function initMainHopper() {
  ...
  var comp = AdobeAnMainHopper.getComposition(
    "367C7A929D59DB45BEA40A799CC821FC"
  );
